...
function StateProvider(Props) {
  ...
  return React.createElement(make, makeProps(React.useReducer(State$ReactHooksTemplate.reducer, State$ReactHooksTemplate.initialState), children, undefined));
}
